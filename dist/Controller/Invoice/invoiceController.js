...
export const userInvoice = async (req, res) => {
    try {
...
// 3. The Controller
export const modifyInvoice = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const { userId, date, customer, items, subtotal, total, discount, received, due, paymentType, description, } = req.body;
